...
buildings = list(df)[17:18] # from position 2 on
print('BB ',buildings)
results = pd.DataFrame()
results['Indicator']=['DHW','HP_Pel','HP_Qth','EB_Pel','TES_Qch','TES_Qdis','HP_Qth_net','EB_Qth','DH_Qth','Qth_dem']
overloadings = 0.
# Twiks
m2ref = 4889 # B5
...
for building in buildings:
    ...
    series_time = eflowsDataDR.iloc[3:endF:2, 0] # DH 
